...
namespace ChatGPTClone.Persistance.Migrations
{
    ...
    [Migration("20240818092023_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatGPTClone.Domain.Identity.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChatGPTClone.Domain.Identity.AppRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ChatGPTClone.Domain.ValueObjects.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("ChatGPTClone.Domain.Identity.AppRoleClaim", b =>
                {
                    b.HasOne("ChatGPTClone.Domain.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ChatGPTClone.Domain.ValueObjects.ChatMessage", b =>
                {
                    b.HasOne("ChatGPTClone.Domain.Entities.ChatSession", null)
                        .WithMany("Messages")
